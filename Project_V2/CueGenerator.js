        ...
        switch(dealer_reco){
            case false:
                if (Math.random() > 0.5){
                    ...
                    var redirect2 = 'questionnaire.html';
            ...
            case true:
                ...
                if (Math.random() > 0.5){
					...
					var reco_attribute = attributes[k];
                    //var redirect = 'dealer_reco.html';
                    if (Math.random() > 0.5){
                        var redirect = 'dealer_reco.html';
                        var redirect2 = 'friend_reco.html';
                    }
                    else {
                        var redirect = 'friend_reco.html';
                        var redirect2 = 'dealer_reco.html';
                        }
